...
namespace SalesAPI2019
{
    public partial class dataContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("data source=api-demos.database.windows.net;initial catalog=data;persist security info=True;user id=api-demos;password=[password];MultipleActiveResultSets=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA57EB539D");
